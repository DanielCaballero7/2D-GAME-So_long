...
int	load_imgs(t_imgs **imgs, t_mlx *mlx)
{
	...
	imgs[0]->img = mlx_xpm_file_to_image(mlx->mlx, "textures/wall.xpm",
			&imgs[0]->width, &imgs[0]->height);
	imgs[1]->img = mlx_xpm_file_to_image(mlx->mlx, "textures/path.xpm",
			&imgs[1]->width, &imgs[1]->height);
	imgs[2]->img = mlx_xpm_file_to_image(mlx->mlx, "textures/paulinol1.xpm",
			&imgs[2]->width, &imgs[2]->height);
	imgs[3]->img = mlx_xpm_file_to_image(mlx->mlx, "textures/selene.xpm",
			&imgs[3]->width, &imgs[3]->height);
	imgs[4]->img = mlx_xpm_file_to_image(mlx->mlx, "textures/exit.xpm",
